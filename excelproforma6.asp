...
'end
	...
	Select Case OutputType
		...
		Case "proforma":
			...
			'oExcel.cells(13,12).VALUE = "Lic. Juan José Zontas Sing "
			'oExcel.cells(14,12).VALUE = "Calle 122 Via José Agustín Arango"
			'oExcel.cells(15,12).VALUE = "Corregimiento de Juan Díaz, "
			'oExcel.cells(16,12).VALUE = "Centro Industrial Balzac, "
			'oExcel.cells(17,12).VALUE = "Local No. 4 Ciudad de Panamá, Panamá "
...
'VIETNAM
		...
		elseif (ucase(trim(curCountry))= "SPAIN" or ucase(trim(curCountry))= "SPAIN" or ucase(trim(curCountry))= "ESPAÑA") and ucase(trim(curClient)) = "SANGUESA SA" then  'SANGUESA S A
...
'VIETNAM
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+8-nExtraLines))).font.size=26
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+8-nExtraLines))).value="Regions Bank"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+8-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+9-nExtraLines))).value="ACCT: # 0198073737"
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+10-nExtraLines))).value="ABA: 063104668"
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+11-nExtraLines))).value="8900 SW 107 Ave"
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+12-nExtraLines))).value="Miami, FL 33176"
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+13-nExtraLines))).value="SWIFT: UPNBUS44MIA"
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+14-nExtraLines))).value="Phone: (305) 596-3697"
...
sub Dibujar()
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+8-nExtraLines))).font.size=26
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+8-nExtraLines))).value="BANKING INFORMATION: Please send payment to:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+8-nExtraLines))).font.bold=True
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+9-nExtraLines))).value="First American Bank, Elk Grove Village, IL USA"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+9-nExtraLines))).font.bold=True
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+10-nExtraLines))).value="With the Federal Reserve Bank"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+10-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+10-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+11-nExtraLines))).value="ABA no. 071-922-777"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+11-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+11-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+12-nExtraLines))).value="For Credit to Trade Finance Division"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+12-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+12-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+13-nExtraLines))).value="Account 78 11 57 1118: Referencing Demetech Corporation"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+13-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+13-nExtraLines))).font.size=26
		
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+15-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+15-nExtraLines))).value="AGREED & ACCEPTED:"
		'xlContinuous
		...
		'oExcel.ActiveSheet.Range("C13:I13").Select
		oExcel.ActiveSheet.Range("D"+trim(cSTR(currow+16-nExtraLines))).select
			With oExcel.Selection.Borders(xlEdgeBottom)
						.LineStyle = xlContinuous
						
						.ColorIndex = xlAutomatic
		End With
		oExcel.ActiveSheet.Range("E"+trim(cSTR(currow+16-nExtraLines))).select
			With oExcel.Selection.Borders(xlEdgeBottom)
						.LineStyle = xlContinuous
						
						.ColorIndex = xlAutomatic
		End With
		oExcel.ActiveSheet.Range("F"+trim(cSTR(currow+16-nExtraLines))).select
			With oExcel.Selection.Borders(xlEdgeBottom)
						.LineStyle = xlContinuous
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+16-nExtraLines))).value="Buyer:                            " & trim(curClient) 
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+16-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+16-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+18-nExtraLines))).value="Signature:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+18-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+18-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+19-nExtraLines))).value="Print Name:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+19-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+19-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+20-nExtraLines))).value="Title:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+20-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+20-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+21-nExtraLines))).value="Date:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+21-nExtraLines))).font.bold=True
		...
		oExcel.ActiveSheet.Range(rangestr).Select
		 With oExcel.Selection
			...
			.MergeCells = True
	    End With
		rangestr = "C"+trim(cSTR(currow+25-nExtraLines))+":C"+trim(cSTR(currow+25-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		With oExcel.Selection
				.Delete(-4159)
		end With
		if cdbl(curadjust)=0 and cdbl(curFreight)=0  then 
		rangestr = "B"+trim(cSTR(currow+25-nExtraLines))+":B"+trim(cSTR(currow+25-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		With oExcel.Selection
				.Delete(-4159)
		end With
		rangestr = "A"+trim(cSTR(currow+25-nExtraLines))+":A"+trim(cSTR(currow+25-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		With oExcel.Selection
				.Delete(-4159)
		end With
		...
		if  OutputType = "proforma"  and not left(passedPO,1)="Q" and not left(curpricetype,1)="U" then 
					...
					' oExcel.Columns("E:E").Select
					' oexcel.Selection.delete
					rangestr = "B1:B"+trim(cSTR(currow+25-1))
					response.Write(rangestr)
					oExcel.ActiveSheet.Range(rangestr).Select
					With oExcel.Selection
					'.EntireColumn.Delete  //// MODIFIQUE AQUI 14-6-2016 Acordate!!!
 		end With
		end if 
...
oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+16-nExtraLines))).font.bold=True
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+17-nExtraLines))).value="Buyer:                            " & trim(curClient) 
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+17-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+17-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+19-nExtraLines))).value="Signature:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+19-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+19-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+20-nExtraLines))).value="Print Name:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+20-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+20-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+21-nExtraLines))).value="Title:"
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+21-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+21-nExtraLines))).font.size=26
		
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+22-nExtraLines))).value="Date:"
		...
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+24-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("A"+trim(cSTR(currow+24-nExtraLines))).value=trackstr
		
		
		oExcel.ActiveSheet.Range("D"+trim(cSTR(currow+26-nExtraLines))).value="Deposits are Non-refundable, all sales are finals, no returns, confirmed Purchase Orders can not be modified or canceled. Full payment must be received prior to shipment of order.  Interest at a rate of 1 and 1/2 Percent per month will be charged on all delinquent accounts which are not paid when due.   In addition, you will also be responsible for any legal costs incurred by DemeTech Corporation, including attorney's fees, in collecting any past due balances.Attorney's fees in the event of Dispute: In the event of any dispute between parties arising out of or related to this contract, the prevailing party in any litigation shall be entitled to recover reasonable attorney's fees"
		oExcel.ActiveSheet.Range("D"+trim(cSTR(currow+26-nExtraLines))).font.bold=True
		oExcel.ActiveSheet.Range("D"+trim(cSTR(currow+26-nExtraLines))).font.size=30
		'rangestr = "I"+trim(cSTR(currow-2))+":J"+trim(cSTR(currow-2))
		'oExcel.Worksheets("Sheet1").Range(rangestr).MergeCells = True
		rangestr = "D"+trim(cSTR(currow+26-nExtraLines))+":O"+trim(cSTR(currow+26-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		 With oExcel.Selection
			.HorizontalAlignment = xlLeft
			.VerticalAlignment = xlTop
			...
			.MergeCells = True
	    End With
		rangestr = "C"+trim(cSTR(currow+26-nExtraLines))+":C"+trim(cSTR(currow+26-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		With oExcel.Selection
				.Delete(-4159)
		end With
		if cdbl(curadjust)=0 and cdbl(curFreight)=0  then 
		rangestr = "B"+trim(cSTR(currow+26-nExtraLines))+":B"+trim(cSTR(currow+26-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		With oExcel.Selection
				.Delete(-4159)
		end With
		rangestr = "A"+trim(cSTR(currow+26-nExtraLines))+":A"+trim(cSTR(currow+26-nExtraLines))
		oExcel.ActiveSheet.Range(rangestr).Select
		With oExcel.Selection
				.Delete(-4159)
		end With
		...
		if  OutputType = "proforma"  and not left(passedPO,1)="Q" and not left(curpricetype,1)="U" then 
					...
					' oExcel.Columns("E:E").Select
					' oexcel.Selection.delete
					rangestr = "B1:B"+trim(cSTR(currow+26-1))
					response.Write(rangestr)
					'oExcel.ActiveSheet.Range(rangestr).Select
					'With oExcel.Selection
					'.EntireColumn.Delete
